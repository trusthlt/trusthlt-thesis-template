...
Alle wörtlich zitierten oder sinngemäß wiedergegebenen Textpassagen aus externen Quellen und aus externen Quellen übernommene Abbildungen sind ausdrücklich gekennzeichnet 
und angemessen referenziert.
Abbildungen, die auf grundlegenden Konzepten basieren oder erheblich verändert wurden, werden in der Bildunterschrift nicht referenziert.

Hier ist die detaillierte Liste, die die Verwendung aller KI-Tools in Bezug auf ihren Zweck oder ihr Ergebnis beschreibt, beigefügt und könnte wie folgt aussehen:
\subsection*{KI-Index}
[Referenz 1]: [Prompt], [Anwendung], [Tool-Name], [Software-Version], [Zugriffsdatum]
[Referenz 2]: [Eingabeaufforderung], [Anwendung], [Tool-Name], [Softwareversion], [Zugriffsdatum]
[Referenz 3]: [Eingabeaufforderung], [Anwendung], [Tool-Name], [Softwareversion], [Zugriffsdatum]

%Beispiel
%KI-Index
%In Abschnitt 1.2.3 wurde ChatGPT verwendet, um die Erklärung der Umwandlung von Dezimal- in Binärzahlen zu generieren.
%In Abschnitt 2.5, Abbildung 2.5.2, wurde Gemini 2.5 Pro verwendet, um den Kontrollflussgraphen des in Abbildung 2.5.1 dargestellten Code-Schnipsels zu generieren und zu beschriften.
...
Any text passages quoted verbatim or closely paraphrased from external sources and figures adapted from external sources are explicitly marked 
and adequately referenced.
Figures based on foundational concepts or significantly modified are not referenced in the caption.

Here is the detailed list describing the use of all AI tools in relation to their purpose or result is attached and could look as follows:
\subsection*{AI Index}
[Reference 1]: [Prompt], [Application], [Tool Name], [Software Version], [Access Date]
[Reference 2]: [Prompt], [Application], [Tool Name], [Software Version], [Access Date]
[Reference 3]: [Prompt], [Application], [Tool Name], [Software Version], [Access Date]

%Example
%AI Index
%In Section 1.2.3, ChatGPT was used to generate the explanation of decimal to binary number
%conversion.
%In Section 2.5., Figure 2.5.2, Gemini 2.5 Pro was used to generate and label the control flow graph of the given code snippet in Figure 2.5.1.
